const state = JSON.parse(localStorage.getItem('fitbloq-state') || localStorage.getItem('fitblocks-state') || 'null') || {
  calories: 2000,
  meals: [],
  workoutLogs: [],
  runWeek: 1,
